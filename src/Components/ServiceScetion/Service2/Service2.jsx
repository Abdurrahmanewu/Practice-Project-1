      ...
      <div className="items-center max-w-7xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
          ...
          <div className="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
            <div>
              ...
              >
                ...
                <AllIcons name="rightArrow" className="w-5 h-5 ml-1" />
              </a>
            </div>
            <div>
              <a
        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          ...
          <StateCard
            icon="users"
            title="600M+ Users"
            description="Trusted by over 600 milion users around the
                        world"
            className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
          />
          <StateCard
            icon="globe"
            title="100+ countries"
            description="Have used Landwind to create functional
                        websites"
            className="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
          />
          <StateCard
